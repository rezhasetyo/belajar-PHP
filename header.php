<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  <a class="navbar-brand" href=""> Daftar Hutang ter-Update </a>
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item <?php if ($hal=='') echo "active";?>">
        <a class="nav-link" href="index.php">Depan <span class="sr-only">(current)</span></a>
      </li>

      <li class="nav-item <?php if ($hal=='form') echo "active";?>">
        <a class="nav-link" href="?hal=form">Form</a>
      </li>
      
      <li class="nav-item <?php if ($hal=='data') echo "active";?>">
